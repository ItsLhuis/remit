...
// upload route all need the same numbers, and `lib/storage` is the one module all of them may
...
// it once here is what keeps the client's pre-check, the upload route, and the server's verification
// from drifting apart.
