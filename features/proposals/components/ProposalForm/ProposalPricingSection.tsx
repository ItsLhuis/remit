...
type ProposalPricingSectionProps = {
...
const ProposalPricingSection = ({
  ...
  // The pricing lives here rather than in ProposalForm so that the fields above are outside the
  ...
  return (
    <Fragment>
      <ProposalLineItemsField
        ...
        disabled={disabled}
      />
      <ProposalTotalsPanel totals={totals} currency={resolvedCurrency} locale={locale} />
    </Fragment>
  )
}

export { ProposalPricingSection }
