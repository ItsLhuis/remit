...
discussions, and any commit or comment in this repository — and also applies when an individual is
...
maintainers responsible for enforcement by opening a
[private security advisory](https://github.com/ItsLhuis/remit/security/advisories/new), which is the
repository's private reporting channel and is not limited to security reports.
